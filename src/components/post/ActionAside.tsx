...
function ShareButton() {
  ...
  const text = `Hey, I just found an awesome article: "${postTitle}". Take a look!`
          ...
          <ul className="flex flex-col gap-2">
            {shareList.map((item) => (
              <li
                ...
                role="button"
                aria-label={`Share via ${item.name}`}
              >
  ...
  return (
    ...
    >
      <h2 className="text-center mb-5">
        Thank you for your generous support. It serves as my greatest motivation to continue moving forward.
      </h2>
