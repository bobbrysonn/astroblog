...
export function TimelineProgress() {
  ...
  return (
    <>
      <p className="mt-4">
        Today is day <CountUp to={dayOfYear} decimals={0} /> of the year {currentYear}
      </p>
      <p className="mt-4">
        <CountUp to={percentOfYear} decimals={5} />% of this year has passed
      </p>
      <p className="mt-4">
        <CountUp to={percentOfToday} decimals={5} />% of today has passed
      </p>
    </>
  )
